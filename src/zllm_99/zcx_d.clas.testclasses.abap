...
CLASS ltc_zcx_d_instance DEFINITION FOR TESTING
    RISK LEVEL HARMLESS
    DURATION SHORT.

  PRIVATE SECTION.
    DATA: gv_msg TYPE string.
    DATA: cut TYPE REF TO zcx_d.
    METHODS one_msg_implicit FOR TESTING RAISING zcx_d.
    METHODS one_msg_implicit_type_e FOR TESTING RAISING zcx_d.
    METHODS one_msg_implicit_type_e_as_w FOR TESTING RAISING zcx_d.
    METHODS one_msg_implicit_type_e_as_a FOR TESTING RAISING zcx_d.
    METHODS one_msg_implicit_type_e_as_i FOR TESTING RAISING zcx_d.
    METHODS one_msg_implicit_type_e_as_s FOR TESTING RAISING zcx_d.
    METHODS one_msg_implicit_type_args FOR TESTING RAISING zcx_d.
    METHODS one_msg_explicit FOR TESTING RAISING zcx_d.
    METHODS one_msg_explicit_type FOR TESTING RAISING zcx_d.
    METHODS one_msg_add_and_throw FOR TESTING RAISING zcx_d.
    METHODS two_msg_implicit FOR TESTING RAISING zcx_d.
    METHODS two_msg_implicit_order FOR TESTING RAISING zcx_d.
    METHODS two_msg_chain_add_add FOR TESTING RAISING zcx_d.
    METHODS setup.
ENDCLASS.

CLASS ltc_zcx_d_instance IMPLEMENTATION.
...
CLASS ltc_zcx_d_static DEFINITION FOR TESTING
    RISK LEVEL HARMLESS
    DURATION SHORT.
...
CLASS ltc_zcx_d_static IMPLEMENTATION.
