...
CLASS ltc_zcx_n_instance DEFINITION FOR TESTING
    RISK LEVEL HARMLESS
    DURATION SHORT.

  PRIVATE SECTION.
    DATA: gv_msg TYPE string.
    DATA: cut TYPE REF TO zcx_n.
    ...
    METHODS one_msg_implicit_type_e_as_a FOR TESTING .
    METHODS one_msg_implicit_type_e_as_i FOR TESTING .
    METHODS one_msg_implicit_type_e_as_s FOR TESTING .
    ...
    METHODS one_msg_add_and_throw FOR TESTING .
...
CLASS ltc_zcx_n_instance IMPLEMENTATION.
...
CLASS ltc_zcx_n_static DEFINITION FOR TESTING
    RISK LEVEL HARMLESS
    DURATION SHORT.
...
CLASS ltc_zcx_n_static IMPLEMENTATION.
