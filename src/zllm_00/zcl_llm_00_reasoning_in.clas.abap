CLASS zcl_llm_00_reasoning_in DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE .
  ...
  PUBLIC SECTION.
    ...
    TYPES ts_ TYPE zif_llm_00_types=>ts_reasoning .

    CLASS-METHODS new
      IMPORTING
        !is_       TYPE ts_
      RETURNING
        VALUE(ro_) TYPE REF TO zcl_llm_00_reasoning_in
      RAISING
        zcx_s .
...
CLASS ZCL_LLM_00_REASONING_IN IMPLEMENTATION.
