...
CLASS zcl_llm_00_chat_in DEFINITION LOCAL FRIENDS lcl_.
...
.
  PRIVATE SECTION.
    DATA:
      cut TYPE REF TO zcl_llm_00_chat_in.  "class under test
...
CLASS lcl_ IMPLEMENTATION.
  ...
  METHOD setup.
    DATA: ls_ TYPE zcl_llm_00_chat_in=>ts_.
    cut = zcl_llm_00_chat_in=>new( ls_ ).
  ENDMETHOD.
