...
CLASS zcl_llm_00_chat_out DEFINITION LOCAL FRIENDS lcl_.
...
.
  PRIVATE SECTION.
    DATA:
      cut TYPE REF TO zcl_llm_00_chat_out.  "class under test
...
CLASS lcl_ IMPLEMENTATION.
  ...
  METHOD setup.
    DATA: ls_ TYPE zcl_llm_00_chat_out=>ts_.
    cut = zcl_llm_00_chat_out=>new( ls_ ).
  ENDMETHOD.
