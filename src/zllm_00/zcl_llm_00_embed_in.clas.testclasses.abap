...
CLASS zcl_LLM_00_embed_in DEFINITION LOCAL FRIENDS lcl_.
...
.
  PRIVATE SECTION.
    DATA:
      cut TYPE REF TO zcl_LLM_00_embed_in.  "class under test
...
CLASS lcl_ IMPLEMENTATION.
  ...
  METHOD setup.
    DATA: ls_ TYPE zcl_LLM_00_embed_in=>ts_.
    cut = zcl_LLM_00_embed_in=>new( ls_ ).
  ENDMETHOD.
